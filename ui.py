...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_task5.setGeometry(QtCore.QRect(900, 520, 311, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_task1.setText(_translate("MainWindow", "OP START", None))
        self.btn_task2.setText(_translate("MainWindow", "RECORD", None))
        self.btn_task3.setText(_translate("MainWindow", "OP EX", None))
        self.btn_task4.setText(_translate("MainWindow", "OP PLAY", None))
        self.btn_task5.setText(_translate("MainWindow", "FK CHECK", None))
